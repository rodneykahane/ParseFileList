...
namespace ParseFileList
{
    ...
    public class PeekableInputStream : Stream
    {
        ...
        /// <summary>
        /// Construct a peekable input stream based on the
        /// specified stream.
        /// </summary>
        ...
        /// <summary>
        /// Specifies that the stream cannot determine its
        /// position.
        /// </summary>
        ...
        /// </summary>
        /// <param name="buffer">The buffer to read the
        /// bytes into.</param>
        /// <param name="offset">The offset to begin storing
        /// the bytes at.</param>
        ...
        /// Read a single byte.
        /// </summary>
        /// <returns>The byte read, or -1 for end of stream.
        /// </returns>
        public int Read()
        {
            byte[] b = new byte[1];
        ...
        {
            // does the size of the peek buffer need to
            // be extended?
            ...
            if (depth >= this.peekLength)
            {
                ...
                int lengthRead = this.stream.Read(
                this.peekBytes, offset, length);
                if (lengthRead < 1)
                {
                    return -1;
                }
